...
```cpp
// x is assumed to be of type uint8_t[4], reinterpret_cast reads all of it as one uint32_t
__m512i inputs = _mm512_set1_epi32(*reinterpret_cast<const uint32_t*>(&x)); 
__m512i weights = _mm512_loadu_si512(reinterpret_cast<const __m512i*>(&weights));
...
// TO
outputs = _mm256_madd_epi32(_mm256_maddubs_epi16(outputs, inputs, weights), _mm256_set1_epi16(1));
```
